    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.GET,"/member/scrap").authenticated()
                    .requestMatchers(HttpMethod.POST,"/member/scrap").authenticated()
                    .requestMatchers(HttpMethod.DELETE,"/member/scrap/*").authenticated()
                    .requestMatchers(HttpMethod.PUT,"/member/scrap/*").authenticated()
